...
<body>
	<div class="container">
		...
		<div class="card">
				...
				<div class="card-body">
					<form method="post">
						<h4 class="card-title">Teka-teki 12</h4>
						<a href="https://www.youtube.com/watch?v=niL4bn_vjiQ&t=109s">Klik Link ini</a>
		...
		<?php
			if(isset($_POST['answer'])) {
				...
				if ($_POST['answer'] != 'esd{nahgitudongdibaca}') {
					echo 'Tebakan anda salah';
				} else {
					header("Location: tigabelas.php");
    				exit;
				}
			}
		?>
